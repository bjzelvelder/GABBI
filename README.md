...
```
singularity exec GABBI_v1.1.0.sif phylomera_v0.8.3.sh \
...
```
singularity exec GABBI_v1.1.0.sif /opt/aTRAM/atram_preprocessor.py xxx
```
...
split fasta
refseq files
parallel -j xx singularity exec GABBI_v1.1.0.sif /opt/aTRAM/atram.py xxx
```
